...
export default function QuickActions() {
  return (
    <Card padding="md">
      ...
      {/* ponytail: no /events/create route — the events page opens the modal off ?create=true */}
      <Button size="lg" leftIcon={FiPlus} href="/organization/events?create=true" className="w-full">
        Create Event
      </Button>
