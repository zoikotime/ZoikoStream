      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 rounded-full border border-slate-200 py-1 pl-1 pr-2.5 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800"
          >
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 z-20 mt-2 w-52 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-800">
