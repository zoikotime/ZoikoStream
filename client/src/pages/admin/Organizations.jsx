        ...
        <div className="border-b border-slate-100 p-4 dark:border-slate-800">
          <div className="relative max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-10 pr-4 text-sm text-slate-800 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:ring-violet-500/20"
            />
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[640px]">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {rows.map((o) => (
                <tr key={o.name} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  <td className={td}>
                  ...
                  <td className={td}>
                    <Badge status={o.status.toLowerCase()}>{o.status}</Badge>
                  </td>
